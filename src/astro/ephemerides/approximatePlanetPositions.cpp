                                    ...
                                    const int planet )
{
    ...
    const double KM = AU;
    const double MuSun = 1.327124280000000e+020;  //Gravitational constant of Sun);
    double Kepl_Par[6];
    double XM;
    ...
    Kepl_Par[5] = tudat::orbital_element_conversions::convertMeanAnomalyToEccentricAnomaly(Kepl_Par[1],Kepl_Par[5]);

    Eigen::Vector6d keplerElements;
    keplerElements<<Kepl_Par[ 0 ], Kepl_Par[ 1 ], Kepl_Par[ 2 ], Kepl_Par[ 4 ], Kepl_Par[ 3 ], Kepl_Par[5];
    keplerElements( 5 ) = tudat::orbital_element_conversions::convertEllipticalEccentricAnomalyToTrueAnomaly(
                keplerElements( 5 ), keplerElements( 1 ) );
    return tudat::orbital_element_conversions::convertKeplerianToCartesianElements(
                keplerElements, MuSun );
