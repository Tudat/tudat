 ...
 */
template< typename TimeType >
TimeType convertTDBtoTT( const TimeType tdbTime, const double universalTimeFractionOfDay, const double stationLongitude,
                         const double distanceFromSpinAxis, const double distanceFromEquatorialPlane )
{
    return tdbTime - static_cast< TimeType >(
                getTDBminusTT( tdbTime, universalTimeFractionOfDay, stationLongitude, distanceFromSpinAxis,
