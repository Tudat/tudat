...
void testTimeConversions( )
{
    ...
    ScalarType utcSecondsSinceJ2000 =
            convertCalendarDateToJulianDaysSinceEpoch< ScalarType >( year, months, days, hours, minutes, seconds,
...
BOOST_AUTO_TEST_CASE( testSofaTimeConversions )
{
...

    {
        ...
        Eigen::Vector3d referencePoint = ( Eigen::Vector3d( )<<xyz[ 0 ], xyz[ 1 ], xyz[ 2 ] ).finished( );
        ...
        // Check validity of using TT as subsititute for TDB
