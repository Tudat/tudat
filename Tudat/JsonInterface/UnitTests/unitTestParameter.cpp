...
BOOST_AUTO_TEST_CASE( test_json_acceleration_sphericalHarmonicGravity )
{
    ...
    parameterNames.push_back( boost::make_shared< EmpiricalAccelerationEstimatableParameterSettings >(
                                 "Vehicle", "Earth", empiricalAccelerationComponents ) );
    parameterNames.push_back( boost::make_shared< ArcWiseRadiationPressureCoefficientEstimatableParameterSettings >(
    ...
    parameterNames.push_back( boost::make_shared< DirectTidalTimeLagEstimatableParameterSettings >(
    ...
    std::string fileName = "/home/dominic/Software/numericalAstrodynamicsTudatBundle/tudatBundle/tudat/Tudat/JsonInterface/UnitTests/outputParameter.json";
    ...
    std::vector< boost::shared_ptr< EstimatableParameterSettings > > parameterNamesFromFile =
            parseJSONFile< std::vector< boost::shared_ptr< EstimatableParameterSettings > > >( fileName );
