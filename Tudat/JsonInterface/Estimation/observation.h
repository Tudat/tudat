...
void to_json( nlohmann::json& jsonObject, const boost::shared_ptr< ObservationSettings >& parameterSettings );

//! Create a shared pointer to a `ObservationSettings` object from a `json` object.
void from_json( const nlohmann::json& jsonObject, boost::shared_ptr< ObservationSettings >& parameterSettings );




//! Create a `json` object from a shared pointer to a `ObservationSettings` object.
void to_json( nlohmann::json& jsonObject, const boost::shared_ptr< ObservationBiasSettings >& parameterSettings );

//! Create a shared pointer to a `ObservationSettings` object from a `json` object.
void from_json( const nlohmann::json& jsonObject, boost::shared_ptr< ObservationBiasSettings >& parameterSettings );
...
//! Create a shared pointer to a `ObservationSettings` object from a `json` object.
void from_json( const nlohmann::json& jsonObject, boost::shared_ptr< ObservationSimulationTimeSettings< double > >& observationSimulationTimeSettings );
...
//! Create a shared pointer to a `ObservationSettings` object from a `json` object.
void from_json( const nlohmann::json& jsonObject, boost::shared_ptr< ObservationViabilitySettings >& observationViabilitySettings );
