...
public:
    PanelledRadiationPressurePartial(
            const boost::shared_ptr< electro_magnetism::PanelledRadiationPressureAcceleration > radiationPressureAcceleration,
            const boost::shared_ptr< electro_magnetism::PanelledRadiationPressureInterface > radiationPressureInterface,
...
private:
    ...
    boost::shared_ptr< electro_magnetism::PanelledRadiationPressureAcceleration > radiationPressureAcceleration_;

    boost::shared_ptr< electro_magnetism::PanelledRadiationPressureInterface > radiationPressureInterface_;
