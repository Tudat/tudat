...
Vector6d RarefiedFlowAnalysis::getAerodynamicCoefficientsDataPoint(
...
void RarefiedFlowAnalysis::determineVehicleCoefficients(
...
Vector6d RarefiedFlowAnalysis::determinePartCoefficients(
