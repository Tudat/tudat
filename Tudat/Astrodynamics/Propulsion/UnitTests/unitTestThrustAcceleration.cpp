...
BOOST_AUTO_TEST_CASE( testCombinedThrustAndAerodynamicAcceleration )
{
    using namespace tudat;
    using namespace numerical_integrators;
    using namespace simulation_setup;
    ...
    // Create Earth object
    NamedBodyMap bodyMap = createBodies( getDefaultBodySettings( boost::assign::list_of( "Earth" ), -1.0E6, 1.0E6 ) );
    ...
    boost::shared_ptr< AerodynamicCoefficientSettings > aerodynamicCoefficientSettings =
            boost::make_shared< ConstantAerodynamicCoefficientSettings >(
                2.0, 4.0, 1.5, Eigen::Vector3d::Zero( ), Eigen::Vector3d::UnitX( ) );
