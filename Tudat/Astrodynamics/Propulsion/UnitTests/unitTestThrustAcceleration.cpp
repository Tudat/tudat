...
BOOST_AUTO_TEST_CASE( testAccelerationLimitedGuidedThrust )
{
    ...
    // Set simulation end epoch.
    const double simulationEndEpoch = 72.0 * 3600.0;
    ...
    for( unsigned int i = 0; i < 5; i++ )
    {
        ...
        if( i == 1 )
        {
            BOOST_CHECK_EQUAL( ( std::fabs( finalModifiedEquinoctialElementsError( 1 ) ) > 0.5 ), true );
        }
        else
        {
        ...
        if( i == 2 )
        {
            BOOST_CHECK_EQUAL( ( std::fabs( finalModifiedEquinoctialElementsError( 2 ) ) > 0.5 ), true );
        }
        else
        {
        ...
        if( i == 3 )
        {
            BOOST_CHECK_EQUAL( ( std::fabs( finalModifiedEquinoctialElementsError( 3 ) ) > 0.2 ), true );
        }
        else
        {
            BOOST_CHECK_EQUAL( ( std::fabs( finalModifiedEquinoctialElementsError( 3 ) ) < 0.01 ), true );
        }

        if( i == 4 )
        {
            BOOST_CHECK_EQUAL( ( std::fabs( finalModifiedEquinoctialElementsError( 4 ) ) > 0.2 ), true );
        }
        else
        {
            BOOST_CHECK_EQUAL( ( std::fabs( finalModifiedEquinoctialElementsError( 4 ) ) < 0.01 ), true );
        }
