...
BOOST_AUTO_TEST_CASE( testNWayRangeModel )
{
    ...
    // Define link ends for observations.
    {
             ...
             linkEndIterator++ )
        {
            ...
            TUDAT_CHECK_MATRIX_CLOSE_FRACTION( ( uplinkRange + downlinkRange ), twoWayRange,
                                               std::numeric_limits< double >::epsilon( ) );
        }
    }
    ...
    // Define link ends for observations.
    {
        ...
        boost::shared_ptr< NWayRangeObservationSettings > fourWayObservableSettings =
                boost::make_shared< NWayRangeObservationSettings >( fourWayLinkSettings );
             ...
             linkEndIterator++ )
        {
            ...
            TUDAT_CHECK_MATRIX_CLOSE_FRACTION(
                        ( firstlinkRange + secondlinkRange + thirdlinkRange + fourthlinkRange ), fourWayRange,
                                               std::numeric_limits< double >::epsilon( ) );
        }
    }
