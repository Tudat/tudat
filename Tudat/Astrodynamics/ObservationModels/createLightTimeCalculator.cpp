        ...
        boost::function< basic_mathematics::Vector6d( const double& ) > referencePointRelativeStateFunction )
{
    ...
    //boost::function< basic_mathematics::Vector6d( const Time& ) > referencePointRelativeStateFunction =
    //        boost::bind( &GroundStation::getStateInPlanetFixedFrame< Time >, groundStation, _1 );
