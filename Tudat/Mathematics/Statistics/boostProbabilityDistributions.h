...
/*!
 *  Interface for continuous random variable calculations using distributions implemented in boost. Derives from the UnivariateContinuousProbabilityDistribution
...
/*!
 *  Function to create a random variable class of BoostContinuousProbabilityDistribution type, which links random variable interfaces of this architecture
