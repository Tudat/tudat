...
//                const std::map< int, std::shared_ptr< EstimatableParameter< Eigen::Matrix< InitialStateParameterType, Eigen::Dynamic, 1 > > > >&
...
//
//    for ( auto itr : initialMultiArcStateParameters )
//    {
//        switch ( itr.second->getParameterName( ).first == arc_wise_initial_body_state )
//        {
//            case arc_wise_initial_body_state:
//            {
//
