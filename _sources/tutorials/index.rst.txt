...
We recommend to start going through the :ref:`preknowledgeIndex` pages, since these contain essential information necessary to understand the rest of the tutorials. Once you feel confortable, we advise you to look at the , which systematically explain some of the example applications included in the Tudat Bundle. These are very helpful to understand the interaction between the Tudat libraries and how a simulation is properly set up. Next, the pages discuss the details behind the Tudat libraries. 
