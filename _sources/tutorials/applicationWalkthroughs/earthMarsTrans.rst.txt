...
=====================================
The examples described in this tutorial will cover a direct transfer from Earth to Mars using a Lambert targeter. The code for this tutorial is given here on Github, and is also located in your tudat bundle at:
