...
To download the Tudat Bundle you have several options, which are more or less advanced and depend on your use case and experience with git. **Those students following the Space Project course at TU Delft should select the SmartGit (Developer) guide.**
