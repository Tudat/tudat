...
void VehicleModel::setExternalModel(VehicleExternalModel& externalModel)
{
...
VehicleExternalModel* VehicleModel::getPointerToExternalModel( )
{
...
std::ostream& operator<<( std::ostream& stream, VehicleModel& vehicleModel )
{
    stream << "This is a vehicle model; the following properties have been set:" << std::endl;
    if( vehicleModel.isExternalModelSet_ == true)
    {
