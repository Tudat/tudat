 ...
 *    Source file of unit test file of libration point code. This unit test
...
bool testLibrationPointLocations( )
{
    ...
    if ( abs( ( librationPoint.getMassParameter( ) ) - 0.01215295290792761 )
         / 0.01215295290792761  > MACHINE_PRECISION_DOUBLES )
    {
                                   ...
                                   double massParameter )
{
    ...
    if ( abs( positionOflibrationPointL1.getCartesianElementX( ) - 0.83629259089993 )
         / 0.83629259089993 > MACHINE_PRECISION_DOUBLES
         || abs( positionOflibrationPointL1.getCartesianElementY( ) ) > 0.0
         || abs( positionOflibrationPointL1.getCartesianElementZ( ) ) > 0.0 )
    {
        isLibrationPointComputationErroneous = true;
                                   ...
                                   double massParameter )
{
    ...
    if ( abs( positionOflibrationPointL2.getCartesianElementX( ) - 1.15616816590553 )
         / 1.15616816590553 > MACHINE_PRECISION_DOUBLES
         || abs( positionOflibrationPointL2.getCartesianElementY( ) ) > 0.0
         || abs( positionOflibrationPointL2.getCartesianElementZ( ) ) > 0.0 )
    {
        isLibrationPointComputationErroneous = true;
                                   ...
                                   double massParameter )
{
    ...
    if ( abs( positionOflibrationPointL3.getCartesianElementX( ) + 1.00511551160689 )
         / -1.00511551160689 > MACHINE_PRECISION_DOUBLES
         || abs( positionOflibrationPointL3.getCartesianElementY( ) ) > 0.0
         || abs( positionOflibrationPointL3.getCartesianElementZ( ) ) > 0.0 )
    {
        isLibrationPointComputationErroneous = true;
                                   ...
                                   double massParameter )
{
    ...
    if ( abs( positionOflibrationPointL4.getCartesianElementX( ) - 0.487722529 )
         / 0.487722529 > MACHINE_PRECISION_DOUBLES
         || abs( positionOflibrationPointL4.getCartesianElementY( ) - 0.86602540378444 )
         / 0.86602540378444 > MACHINE_PRECISION_DOUBLES
         || abs( positionOflibrationPointL4.getCartesianElementZ( ) ) > 0.0 )
    {
        isLibrationPointComputationErroneous = true;
                                   ...
                                   double massParameter )
{
    ...
    if ( abs( positionOflibrationPointL5.getCartesianElementX( ) - 0.487722529 )
         / 0.487722529 > MACHINE_PRECISION_DOUBLES
         || abs( positionOflibrationPointL5.getCartesianElementY( ) + 0.86602540378444 )
         / -0.86602540378444 > MACHINE_PRECISION_DOUBLES
         || abs( positionOflibrationPointL5.getCartesianElementZ( ) ) > 0.0 )
    {
        isLibrationPointComputationErroneous = true;
