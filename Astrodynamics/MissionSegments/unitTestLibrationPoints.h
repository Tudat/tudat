 ...
 *    Header file of unit test file of libration point code. This unit test file will test the
 *    determintation of the locations of the libration points in the Circular Restricted
 *    Three-Body Problem (CRTBP). Computation of the mass parameter is also tested.
 *
 ...
 * dimensionless mass parameter. Computations are done in the Earth-Moon system.
...
/*!
 * Tests determination of L1 location. Computation is done in the Earth-Moon system.
...
/*!
 * Tests determination of L2 location. Computation is done in the Earth-Moon system.
 * \param isLibrationPointComputationErroneous Flag to indicate if test is erroneous.
 * \param massParameter Mass parameter.
 * \return Boolean indicating success of test
 * ( false = successful; true = failed ).
...
/*!
 * Tests determination of L3 location. Computation is done in the Earth-Moon system.
 * \param isLibrationPointComputationErroneous Flag to indicate if test is erroneous.
 * \param massParameter Mass parameter.
 * \return Boolean indicating success of test
 * ( false = successful; true = failed ).
...
/*!
 * Tests determination of L4 location. Computation is done in the Earth-Moon system.
 * \param isLibrationPointComputationErroneous Flag to indicate if test is erroneous.
 * \param massParameter Mass parameter.
 * \return Boolean indicating success of test
 * ( false = successful; true = failed ).
...
/*!
 * Tests determination of L5 location. Computation is done in the Earth-Moon system.
 * \param isLibrationPointComputationErroneous Flag to indicate if test is erroneous.
 * \param massParameter Mass parameter.
 * \return Boolean indicating success of test
 * ( false = successful; true = failed ).
