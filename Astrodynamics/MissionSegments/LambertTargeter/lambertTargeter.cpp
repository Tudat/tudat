 ...
 *      101111    E. Iorfida        Implementation of all the equations up to
 *                                  the Newton method.
 ...
 *                                  added setInitialState, modified
 *      101207    E. Iorfida        punctuation. Set single variables, change
 *                                  variables names in more understandable ones.
 *      101209    E. Iorfida        Corrected some coding errors.
 *      101213    E. Iorfida        Deleted lambertAngle, added
 *                                  numberOfRevolution, modified implementation.
 ...
 *                                  RootFinderAlgorithms and NewtonRaphsonMethod
 *                                  classes.
 ...
 *                                  vector. Corrected computation of transverse
 *                                  heliocentric velocity.
 *      110201    E. Iorfida        Added pointerToCelestialBody and modified
 *                                  variable names (from heliocentric, to
 *                                  inertial). Added patch for negative case of
 *                                  initialLambertGuess_.
 *                                  Added equations references.
 *      110206    E. Iorfida        Added unique function for Newton-Raphson
 *                                  method. Added computeAbsoluteValue to the
 *                                  initialLambertGuess_ for non-converging
 *                                  cases.
