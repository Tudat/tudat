...
bool testKeplerianElements( )
{
    ...
    vectorOfAuxilliaryKeplerianElements_( 0 )
            = vectorOfKeplerianElements_( 3 )
              + vectorOfKeplerianElements_( 4 );
    vectorOfAuxilliaryKeplerianElements_( 1 )
            = vectorOfKeplerianElements_( 3 )
              + vectorOfKeplerianElements_( 4 )
              + vectorOfKeplerianElements_( 5 );
    ...
    keplerianElementsStateTest1_.setSemiMajorAxis(
            vectorOfKeplerianElements_( 0 ) );
    keplerianElementsStateTest1_.setEccentricity(
            vectorOfKeplerianElements_( 1 ) );
    keplerianElementsStateTest1_.setInclination(
            vectorOfKeplerianElements_( 2 ) );
    keplerianElementsStateTest1_.setArgumentOfPeriapsis(
            vectorOfKeplerianElements_( 3 ) );
    keplerianElementsStateTest1_.setLongitudeOfAscendingNode(
            vectorOfKeplerianElements_( 4 ) );
    keplerianElementsStateTest1_.setTrueAnomaly(
            vectorOfKeplerianElements_( 5 ) );

    // Test 1: Get Keplerian elements and store in a state vector.
    VectorXd keplerianElementsStateVectorTest1( 6 );
    keplerianElementsStateVectorTest1( 0 ) = keplerianElementsStateTest1_
                                             .getSemiMajorAxis( );
    keplerianElementsStateVectorTest1( 1 ) = keplerianElementsStateTest1_
                                             .getEccentricity( );
    keplerianElementsStateVectorTest1( 2 ) = keplerianElementsStateTest1_
                                             .getInclination( );
    keplerianElementsStateVectorTest1( 3 ) = keplerianElementsStateTest1_
                                             .getArgumentOfPeriapsis( );
    keplerianElementsStateVectorTest1( 4 ) = keplerianElementsStateTest1_
                                          .getLongitudeOfAscendingNode( );
    keplerianElementsStateVectorTest1( 5 ) = keplerianElementsStateTest1_
                                             .getTrueAnomaly( );

    // Test 1: Difference between setting each Keplerian element and the
    // expected values.
    VectorXd differenceBetweenResultsTest1_( 6 );
    differenceBetweenResultsTest1_ =  keplerianElementsStateVectorTest1
                                     - vectorOfKeplerianElements_;
    ...
    differenceBetweenResultsTest2_ = keplerianElementsStateTest2_.state
                                    - vectorOfKeplerianElements_;
    ...
    auxilliaryKeplerianElementsVectorTest3_( 0 ) = keplerianElementsStateTest2_
                                                  .getLongitudeOfPeriapsis( );
    auxilliaryKeplerianElementsVectorTest3_( 1 ) = keplerianElementsStateTest2_
                                                  .getTrueLongitude( );
    auxilliaryKeplerianElementsVectorTest3_( 2 ) = keplerianElementsStateTest2_
                                                  .getArgumentOfLatitude( );
    auxilliaryKeplerianElementsVectorTest3_( 3 ) = keplerianElementsStateTest2_
                                                  .getSemiLatusRectum( );
    ...
    if ( differenceBetweenResultsTest2_.norm( ) > MACHINE_PRECISION_DOUBLES )
    {
        ...
        // Generate error statements.
        cerr << "The computed value " << endl;
        cerr << "( " << keplerianElementsStateTest2_.state << " )"
             << endl;
        ...
        cerr << "The difference is: "
             << vectorOfKeplerianElements_
                - keplerianElementsStateTest2_.state << endl;
    }
    ...
    if ( differenceBetweenResultsTest3.norm( ) > MACHINE_PRECISION_DOUBLES )
    {
        ...
        // Generate error statements.
        cerr << "The computed value " << endl;
        cerr << "( " << auxilliaryKeplerianElementsVectorTest3_ << " )"
             << endl;
        cerr << "using indivudual set/get functions for the "
             << "auxilliary elements of the KeplerianElements class does "
             << "not match the expected solution " << endl;
        cerr << "( " << vectorOfAuxilliaryKeplerianElements_ << " )."
                << endl;
        cerr << "The difference is: "
             << vectorOfAuxilliaryKeplerianElements_
                - auxilliaryKeplerianElementsVectorTest3_ << endl;
    }
