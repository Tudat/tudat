...
- :jsontype:`string` :jsonkey:`associatedThroustSource` (mandatory if :jsonkey:`useAllThrustModels` set to :literal:`false`). Name of engine model from which thrust is to be derived.
