...
- :jsontype:`boolean` :jsonkey:`preloadKernels` (optional). Whether the kernels should be preloaded from :jsonkey:`.initialEpoch` - :jsonkey:`interpolationOffsets.0` to :jsonkey:`.finalEpoch` + :jsonkey:`interpolationOffsets.1`. Default value: :literal:`true`.
